...
public class Product implements Serializable {
	private static final long serialVersionUID = -7451077088819987978L;
	private int id;
	private String name;
	...
	private transient ProdShipDet detailShipDet; //JVM: skip from serialization
	...
	public void linkShipDetails(ProdShipDet det) {
		detailShipDet = det;
	}
	...
	public String toString() {
		return "Product [id=" + id + ", name=" + name + ", productCatgeory=" + productCatgeory + ", manufactureDate="
				+ manufactureDate + ", price=" + price + ", Shipment Details=" + detailShipDet + "]";
	}
