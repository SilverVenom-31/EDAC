...
//add a static method to return fixed size populated list of banck accounts
	...
	// ??????
	static HashMap<Integer, BankAccount> populateHashAccList() {

		HashMap<Integer, BankAccount> hashMap = new HashMap<>();
		hashMap.put(10, new BankAccount(10, "abc1", SAVING, 10000, parse("2020-01-19")));
		hashMap.put(100, new BankAccount(100, "abc4", FD, 200000, parse("2019-01-19")));
		hashMap.put(34, new BankAccount(34, "abc3", CURRENT, 5000, parse("2010-11-29")));
		hashMap.put(15, new BankAccount(15, "abc6", SAVING, 12000, parse("2011-06-23")));
		hashMap.put(64, new BankAccount(64, "abc8", SAVING, 9000, parse("2020-01-19")));
		hashMap.put(49, new BankAccount(49, "abc2", DMAT, 13000, parse("2020-01-19")));
