...
public class CustomerImpl implements ICustomerDao, AutoCloseable {
	...
	public CustomerImpl(String driveClass, String url, String userName, String password) throws SQLException, ClassNotFoundException {
		...
		cn = fetchDbConnection(driveClass, url,userName, password);
	...
	public Customer authenticatUser(String email, String password) throws SQLException {
		...
		try (ResultSet rst = pst1.executeQuery()) {
			...
			if (rst.next()) {
				c1 = new Customer(rst.getInt(1), rst.getDouble(2), email, rst.getString(4), password,
