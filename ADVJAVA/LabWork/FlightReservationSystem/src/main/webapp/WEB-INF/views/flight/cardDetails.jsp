...
<div id="form-container">
  ...
  <div id="card-front">
    ...
    <div id="image-container">
      <span id="amount">paying: <strong>${sessionScope.aid.price}</strong></span>
      <span id="card-image">
...
<form:form method="post" modelAttribute="passengerDetails">
    ...
    <input name="cardNo" id="card-number" placeholder="16 digit card number" length="16" />
    <div id="cardholder-container">
      <label for="card-holder">Card Holder
      </label>
      <form:input path="name" id="card-holder" placeholder="Name on your card" />
    </div>
